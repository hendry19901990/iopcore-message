...
var Address = iopcore.Address;
var Signature = iopcore.crypto.Signature;
var Message = require('../');
...
describe('Message', function() {
  ...
  var privateKey = iopcore.PrivateKey.fromWIF('cR4qogdN9UxLZJXCNFNwDRRZNeLRWuds9TTSuLNweFVjiaE4gPaq');
  ...
  it('will verify with an uncompressed pubkey', function() {
    var privateKey = new iopcore.PrivateKey('67fd2209ce4a95f6f1d421ab3fbea47ada13df11b73b30c4d9a9f78cc80651ac');
